...
class SugarOrderOfPaymentSubscriber extends BaseSubscriber{
    ...
    public function onUpdate($sugar_oop, $sugar_analysis, $sugar_analysis_orig){
    ...
    public function onDestroy($sugar_oop, $sugar_analysis){
        ...
        $this->__cache->deletePattern(''. config('app.name') .'_cache:sugar_analysis_parameter:findBySampleNoSugarServiceId:'. $sugar_analysis->sample_no .':*');
