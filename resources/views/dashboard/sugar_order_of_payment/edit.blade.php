...
<section class="content">
    ...
    <div class="box">
      ...
      <form method="POST" action="{{ route('dashboard.sugar_order_of_payment.update', $sugar_oop->slug) }}" autocomplete="off">
          ...
          <div class="col-md-5">
            ...
            <div class="box">
              ...
              <div class="box-body">
                ...
                {!! __form::textbox(
                  '12', 'sample_no', 'text', 'Sample No. ', 'Sample No.', old('sample_no') ? old('sample_no') : $sugar_oop->sample_no, $errors->has('sample_no'), $errors->first('sample_no'), ''
                ) !!}
