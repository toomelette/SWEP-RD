...
Route::group(['prefix'=>'dashboard', 'as' => 'dashboard.', 'middleware' => ['check.user_status', 'check.user_route']], function () {
	...
	Route::post('/sugar_analysis/cane_juice_analysis/set_or_no/{slug}', 'SugarAnalysisController@caneJuiceAnalysisSetOrNo')->name('sugar_analysis.cane_juice_analysis_set_or_no');
